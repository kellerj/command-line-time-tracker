...
export function validateAndDefaultInputDateString(dateString) {
  if (!dateString) {
...
export function validateMinutes(val, maxMinutes = 480) {
...
export function validateEntryDescription(input) {
  if (!input) {
...
export function getStartAndEndDates(input) {
